...
- The Dummy Player tab's Volkare mode implementation — designed (see `CONTEXT.md`'s **Volkare Session** entry and [ADR-0004](../adr/0004-volkare-narrates-cards-not-simulates-board.md)) but not yet built. Its Proxy Player mode is still undesigned.
