...
`RuinToken` still tracks only which pile(s) to draw from, plus this flavour string. Exact Lost Legion
ruin data (pile colours/counts, reward strings) and ruin art are still to be sourced.
