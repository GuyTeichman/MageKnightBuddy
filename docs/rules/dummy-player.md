...
- **Advanced Action offer**: when the lowest card is removed from the Advanced Action offer, it is added to the Dummy Player's deck instead of being discarded as usual. The Dummy Player's deck is then reshuffled.
