...
Split into four files by domain area — check the one matching whatever you're touching before introducing a new domain term, and update it the moment a term gets resolved or sharpened. Don't let any of them drift out of sync with the code.
...
- `docs/context-sites.md` — Sites tab (Site, Site Section, Site Category, Site Expansion, Site Catalogue).
